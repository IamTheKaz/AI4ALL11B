print('=== improved_asl_model_gpu.py is running! ===')
# -*- coding: utf-8 -*-
"""
GPU-Optimized ASL Recognition Model
Enhanced version with GPU acceleration, 32x32 images, and advanced regularization
"""
...
print("Starting GPU-optimized ASL model script...")
...
print("GPU-optimized TensorFlow configuration loaded!")
print(f"TensorFlow version: {tf.__version__}")
print(f"Available GPUs: {tf.config.list_physical_devices('GPU')}")

# Configuration - Optimized for GPU training with smaller images
IMG_HEIGHT, IMG_WIDTH = 32, 32  # 🚀 Smaller images for faster training
...
print(f"- Image size: {IMG_HEIGHT}x{IMG_WIDTH} (optimized for speed)")
...
# Data Generator for Training - GRAYSCALE
train_generator = train_datagen.flow_from_directory(
    TRAIN_DATA_DIR,
    target_size=(IMG_HEIGHT, IMG_WIDTH),
    batch_size=BATCH_SIZE,
    class_mode='categorical',
    color_mode='grayscale',  # 🎯 KEY IMPROVEMENT: Grayscale
    subset='training'
)

# Data Generator for Validation - GRAYSCALE
...
# GPU-Optimized Model Architecture - Enhanced with L2 Regularization
...
print("🚀 Training the GPU-optimized model...")
...
try:
    history = model.fit(
        ...
        callbacks=callbacks,
        verbose=1,
        workers=8,  # 🚀 Optimize for GPU
        use_multiprocessing=True  # 🚀 Enable for GPU
    )
...
model.save('./models/improved_asl_model_gpu.h5')
...
print("6. ✅ GPU Optimization: Enabled GPU usage with larger batch size (64)")
print("7. ✅ Faster Training: Reduced image size to 32x32 for speed")
print("8. ✅ Universal Paths: Relative paths work anywhere the repo is cloned")
